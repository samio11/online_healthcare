...
<body>
    ...
    <div class="main">
        ...
        <form action="" method="POST" enctype="multipart/form-data" onsubmit="return updateProfileValidate()">
            ...
            <label for="name">Name:<input type="text" id="name" name="name" value="<?php echo $_SESSION['name'] ?>">
                <p id="nameError"></p>
            </label>
            <label for="email">email:<input type="text" id="email" name="email" value="<?php echo $_SESSION['email'] ?>" disabled></label>
            <label for="phone">Phone:<input type="text" id="phone" name="phone" value="<?php echo $_SESSION['phone'] ?>">
                <p id="phoneError"></p>
            </label>
            <label for="gender">Gender:<input type="text" id="gender" name="gender" value="<?php echo $_SESSION['gender'] ?>" disabled></label>
            <label for="address">Address:<input type="text" id="address" name="address" value="<?php echo $_SESSION['address'] ?>">
                <p id="addressError"></p>
            </label>
