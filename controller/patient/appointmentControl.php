...
if(isset($_REQUEST['confirm'])){
    ...
    $result = $mydb->reqAppointment($conObj, $_SESSION['p_id'],$_SESSION['patientName'],$_SESSION['patientGender'], $_SESSION['patientAddress'],
                                     $d_id, $_SESSION['dname'], $_SESSION['cat'],$_SESSION['gender'], $_REQUEST['time'], $_REQUEST['note']);
    if($result==1)
    {
